...
var AdminSetHandler = (function () {
    function AdminSetHandler() {
    }
    AdminSetHandler.prototype.options = function (req, res) {
        res.writeHead(204, AdminSetHandler.httpHeaders);
        res.end();
    };
    AdminSetHandler.prototype.get = function (req, res, dbc) {
